<template>
    <div id="singUp-employee">
             <h1  class="is-size-2 has-text-centered has-text-primary" style="margin-top:60px ">Sing up</h1>
    ...
    methods: {
        singUp(){
            if (this.password === this.passwordConfirm) {
                ...
                firebase.auth().createUserWithEmailAndPassword(this.user_name,this.password)
                        .then( (user) => {
